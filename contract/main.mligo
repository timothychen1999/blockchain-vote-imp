module Tally = struct
  ...
  let bytes_msg : bytes = bytes msg lxor 
  in 
  let ()
  = if Bytes.length bytes_msg <> 512n then
      failwith "Invalid ballot length"
  in
  ...
  let new_used: nat big_set =
    if (Big_set.mem vp.v store.used_ballot) then
